...
message = tk.Label(window, text="Video Interview"   ,fg="black"  ,width=50  ,height=1,font=('times', 25, 'italic bold underline')) 
...
def register():
    ...
    message = tk.Label(window1, text="Registration Form/ Entry Form "   ,fg="black"  ,width=50  ,height=1,font=('times', 25, 'italic bold underline')) 
    ...
    lbl5 = tk.Label(window1, text="  Loction",width=18  ,fg="Black"  ,bg="White"    ,height=1 ,font=('Arial', 15, ' bold ')) 
    lbl5.place(x=370, y=250)

    txt5 = tk.Entry(window1,width=15  ,bg="White"  ,fg="Black", font=('Arial', 15, ' bold ')  )
    txt5.place(x=650, y=250)

    lbl3 = tk.Label(window1, text=" E-mail",width=18  ,fg="Black"  ,bg="White"    ,height=1 ,font=('Arial', 15, ' bold ')) 
    ...
    while True:
        ...
        for (i, (emotion, prob)) in enumerate(zip(EMOTIONS, preds)):
                    ...
                    if emotion =='happy':
                      ...
                      #  res="Stress"
                    if emotion =='neutral' or  emotion == 'disgust' or  emotion =='sad' or  emotion =='scared'  :
...
##                    if cv2.waitKey(1) & 0xFF == ord('q'):                
       ...
       # with open('reviews.csv', 'a+') as csvFile:
          ...
          #  writer = csv.writer(csvFile)
          #  writer.writerow(row)
           # print("file updated Successfully",count)
##                        count=count+1
##                        print(count)
                            #var=1
##                            if count==6:
