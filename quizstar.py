...
import random
import os
##from video_interview import feedback
##from video_interview import user,res,date,timeStamp
##questions = [
...
lblInstruction.pack(pady=(20,20))

lblRules = Label(
    root,
    text = "This interview contains 5 questions You will get 20 seconds to solve a question\nOnce you select a radio button that will be a final choice\nhence think before you select",
    width = 150,height=30, font = ("Times",12),
    background = "#000000",
    foreground = "#FACA2F",
)
lblRules.pack()
